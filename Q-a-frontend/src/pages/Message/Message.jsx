...
export default function FriendSearch() {
  ...
  useEffect(() => {
    const fetchCurrentUserId = async () => {
      try {
        ...
        const response = await axios.get("https://api-tdminh-17.onrender.com/api/auth/profile", {
  ...
  const fetchIncomingCount = useCallback(async () => {
    try {
      const res = await axios.get(`https://api-tdminh-17.onrender.com/api/friend/incoming-count/${currentUserId}`);
  ...
  const fetchUnreadCounts = useCallback(async () => {
    try {
      const res = await axios.get(`https://api-tdminh-17.onrender.com/api/messages/unread/${currentUserId}`);
      const countMap = {};
  ...
  const fetchTotalUnread = useCallback(async () => {
    try {
      const res = await axios.get(`https://api-tdminh-17.onrender.com/api/messages/unread/total/${currentUserId}`);
  ...
  const fetchFriendList = useCallback(async () => {
    try {
      const res = await axios.get(`https://api-tdminh-17.onrender.com/api/friend/list/${currentUserId}`);
  ...
  const fetchIncomingRequests = useCallback(async () => {
    try {
      const res = await axios.get(`https://api-tdminh-17.onrender.com/api/friend/incoming/${currentUserId}`);
  ...
  const handleSearch = useCallback(async () => {
    try {
      setLoading(true);
      const res = await axios.get("https://api-tdminh-17.onrender.com/api/friend/search", {
  ...
  const sendFriendRequest = async (receiverId) => {
    try {
      await axios.post("https://api-tdminh-17.onrender.com/api/friend/request", {
  ...
  const respondToRequest = async (requestId, status) => {
    try {
      await axios.post(`https://api-tdminh-17.onrender.com/api/friend/respond`, {
        requestId,
        status,
      });
