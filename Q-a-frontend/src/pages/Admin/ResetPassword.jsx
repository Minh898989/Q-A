...
export default function AdminResetPage() {
    ...
    const fetchRequests = async () => {
        const res = await fetch("https://api-tdminh-17.onrender.com/api/admin/reset-requests");
        const data = await res.json();
        setRequests(data);
    };

    const fetchHistory = async () => {
        const res = await fetch("https://api-tdminh-17.onrender.com/api/admin/reset-history");
        const data = await res.json();
        setHistory(data);
    };
    ...
    const handleConfirm = async (email) => {
        const res = await fetch("https://api-tdminh-17.onrender.com/api/admin/reset-confirm", {
            method: "POST",
